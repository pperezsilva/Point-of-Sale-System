...
<div class="container-fluid px-4">
    ...
    <x-breadcrumb.template>
        <x-breadcrumb.item :href="route('panel')" content="Kardex"/>
    ...
    <div class="mb-3">
        <form action="{{route('kardex.index')}}" method="get">
            <div class="row gy-2">
                ...
                <div class="col-sm-8">
                    <select name="producto_id" id="producto_id" class="form-control selectpicker" data-live-search="true" data-size="3" title="Busca un producto aqui">
    ...
    @else
    <p class="text-center my-5">No se encontraron resultados</p>
    @endif
