    ...
    <x-forms.template :action="route('empresa.update', ['empresa' => $empresa])" method='post' patch='true'>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-6">
                ...
                type="number" labelText="Porcentaje de impuesto (%)"/>
            </div>

            <div class="col-md-6">
                <x-forms.input id="abreviatura_impuesto" required="true" :defaultValue="$empresa->abreviatura_impuesto"
                labelText="Abreviatura de impuesto"/>
            </div>

            <div class="col-md-4">
                <x-forms.input id="correo" :defaultValue="$empresa->correo"
                type="email"/>
            </div>
            ...
            <div class="col-12">
               <label for="moneda_id" class="form_label"> Moneda Seleccionada: </label>
