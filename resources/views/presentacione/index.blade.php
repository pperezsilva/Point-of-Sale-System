            ...
            <table id="datatablesSimple" class="table table-striped fs-6">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge rounded-pill text-bg-{{ $presentacione->caracteristica->estado ? 'success' : 'danger' }}">
                                {{ $presentacione->caracteristica->estado ? 'Activo' : 'Eliminado' }} </span>
                        </td>
                        <td>
                            <div class="d-flex justify-content-around">
                                <div>
                                    ...
                                    <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                        ...
                                        <li><a class="dropdown-item" href="{{route('presentaciones.edit',['presentacione'=>$presentacione])}}">Editar</a></li>
                                        @endcan
                                    </ul>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <button title="Eliminar" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$presentacione->id}}" class="btn btn-datatable btn-icon btn-transparent-dark">
                                    ...
                                    @else
                                    <button title="Restaurar" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$presentacione->id}}" class="btn btn-datatable btn-icon btn-transparent-dark">
